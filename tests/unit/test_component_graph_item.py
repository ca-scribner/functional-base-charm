...
class TestExecuted:
    ...
    def test_default(self, component_graph_item_factory):  # noqa: F811
        """Tests that the default value of executed is False."""
        assert component_graph_item_factory(name="test-charm").executed is False

    def test_set_to_true(self, component_graph_item_factory):  # noqa: F811
    ...
    def test_set_to_invalid(self, component_graph_item_factory):  # noqa: F811
...
class TestReadyForExecution:
    def test_no_depends_not_executed(self, component_graph_item_factory):  # noqa: F811
    ...
    def test_no_depends_already_executed(self, component_graph_item_factory):  # noqa: F811
    ...
    def test_when_depends_not_ready(
        self, component_graph_item_with_depends_not_active_factory  # noqa: F811
    ):
    ...
    def test_when_depends_ready(
        self, component_graph_item_with_depends_active_factory  # noqa: F811
    ):
...
class TestStatus:
    def test_prerequisites_inactive(
        self, component_graph_item_with_depends_not_active_factory  # noqa: F811
    ):
    ...
    def test_no_prerequisites_is_executed_status_active(
        self, component_graph_item_active_factory  # noqa: F811
    ):
...
class TestInactivePrerequisites:
    def test_no_depends(self, component_graph_item_factory):  # noqa: F811
        """Tests inactive_prerequisites when CGI has no depends_on."""
        assert len(component_graph_item_factory()._inactive_prerequisites()) == 0

    def test_depends_active(self, component_graph_item_with_depends_active_factory):  # noqa: F811
    ...
    def test_depends_mixed(
        self,
        component_inactive_factory,  # noqa: F811
        component_graph_item_factory,  # noqa: F811
        component_graph_item_active_factory,  # noqa: F811
    ):
